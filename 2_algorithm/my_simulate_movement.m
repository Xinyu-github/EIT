function [vi,xyzr,c2f]= my_simulate_movement( img, xyzr)
...
% $Id: simulate_movement.m 4590 2014-05-02 20:46:17Z bgrychtol $
   ...
   try
       scalar = img.c2f_scalar;
   catch
       scalar = 1;
   end
   % create a mapping matrix from circles/spheres to FEM
