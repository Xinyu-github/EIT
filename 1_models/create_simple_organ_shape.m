function func_selected = create_simple_organ_shape(heart_center,heart_radius, spine_center,lung_center_right)
...
func_selected.inner_heart = @(x,y,z) (x-heart_center(1)).^2+(y-heart_center(2)).^2 < (heart_radius-0.07)^2;
