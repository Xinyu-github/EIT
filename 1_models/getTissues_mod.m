function tissues = getTissues_mod(freq)
%GETTISSUES tissues = gettissues(freq)
%Übergibt alle verfügbaren Tissuewerte für eine bestimmte frequenz in einer
%Struktur
...
% some tissues that were not already given.
% http://niremf.ifac.cnr.it/docs/DIELECTRIC/AppendixC.html#C27
